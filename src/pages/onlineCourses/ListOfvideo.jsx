...
<section className='flex flex-row mq925:flex-col-reverse p-10 mq925:p-4 '>
    ...
    <div className='w-1/4 mq925:w-fit mq925:mb-10 bg-blue h-fit '>
        ...
        <h2 className='uppercase text-white my-0'>Preview Video</h2>
        ...
        <div className=' p-3 h-max  text-white'>
                <h2 className='uppercase my-0'>full Course</h2>
                ...
                >
                  {isCourseInCart ? 'View Cart' : 'Add to Cart'}
                </button>

                <hr className='h-1 bg-white my-3' />
                <ul className='text-xl'>
                    <li>Videos available in hindi</li>
                    <li>Certificate of completion</li>
                    <li>You can subscribe to this full course</li>
                </ul>
        </div>
    </div>
